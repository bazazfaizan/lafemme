                            ...
                            <table class="fl-table">
                                ...
                                <tbody>
                                    ...
                                    if ($_SESSION['loggedIn'] == true) {
                                        ...
                                        $sql = "select fname, lname, gender, address, contact, email from register";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<tr><td>' . $row['fname'] . '</td><td>' . $row['lname'] . '</td><td>' . $row['gender'] . '</td><td>' . $row['address'] . '</td><td>' . $row['contact'] . '</td><td>' . $row['email'] . '</td></tr>';
                                            }
                                        }
